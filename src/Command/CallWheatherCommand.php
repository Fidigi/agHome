...
class CallWheatherCommand extends Command
{
    // the name of the command (the part after "bin/console")
    protected static $defaultName = 'app:call:wheather';
    ...
    protected function configure()
    {
        ...
        ->setDescription('Call api wheather.')
        
        // the full command description shown when running the command with
        // the "--help" option
        ->setHelp('This command load wheather data')
        ;
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $wheather = $this->wheatherManager->generate();
        ...
        $output->writeln(' call successfully!');
    }
}
